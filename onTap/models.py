...
class PricingPlan(models.Model):
    ...
    subtitle = models.CharField(max_length=100, blank=True)
    price = models.CharField(max_length=50)  
    yearly_price = models.CharField(max_length=50, blank=True)  # For yearly pricing option
    billing_cycle = models.CharField(max_length=50, blank=True)  
    yearly_billing_cycle = models.CharField(max_length=50, blank=True, default="/year")  # For yearly billing
    features = models.TextField(help_text="Separate features with newline")
    cta_text = models.CharField(max_length=50, default="Get Started")
    is_popular = models.BooleanField(default=False)
    order = models.IntegerField(default=0)
